...
function SB4InitAPI(wrapperId, config) {
    ...
    this.profileList = [{"d":"Default","w":1280,"h":720,"force":true,"t":"PC","hMap":{},"id":"_"},{"d":"Phone Portrait","w":405,"h":720,"force":false,"t":"PHONE","hMap":{"iMD06C9LLS8R4C4J1H8VO4JBSIO":0,"i915RLLCM03JIE8K8TU5UVO2BI4":0,"i0P13H8QDGQ5QVGVE6DTGISABNG":0,"iVL0AI9O4EMIK622QCL8198CGGK":0},"id":"PHONE-457x720"}];
...
SB4InitAPI.prototype.init = function () {
    ...
    if (this.config["scale"] >= 0) {
        ...
        var sourceHead = heads + '<script src="app/global.js?bust=1.0.0.202404300805_1728374908022"></script><script data-main="main.js?bust=1.0.0.202404300805_1728374908022" src="lib/require.js?bust=1.0.0.202404300805_1728374908022"></script>\n';
        ...
        s1.setAttribute('src', 'app/global.js?bust=1.0.0.202404300805_1728374908022');
        var s2 = document.createElement('script');
        s2.setAttribute('data-main', 'main.js?bust=1.0.0.202404300805_1728374908022');
        s2.setAttribute('src', 'lib/require.js?bust=1.0.0.202404300805_1728374908022');
...
if (typeof _ != 'function') {
    ...
    underScoreScript.src = launchPath + 'lib/underscore-min.js?bust=1.0.0.202404300805_1728374908022';
